//
//  XXYBaseNavigationViewController.m
//  HLNeiHanDuanZI
//
...
@interface XXYBaseNavigationViewController () <UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
+ (void)initialize
{
    ...
    color[NSFontAttributeName] = [UIFont systemFontOfSize:18.0f];
...
//    atts[NSForegroundColorAttributeName] = [UIColor colorWithHexStr:@"#8E9AB5"];
    [item setTitleTextAttributes:atts forState:UIControlStateNormal];

    //隐藏导航条底部的线条
    [[UINavigationBar appearance]setShadowImage:[UIImage imageWithColor:kRGBAColor(178, 213, 255, 0.25)]];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backBtn setImage:[UIImage imageNamed:@"blackBack"] forState:UIControlStateHighlighted];
